! function webpackUniversalModuleDefinition(t, e) {
    ...
    return function(o) {
                ...
                function createNamespace(u) {
                    ...
                    function defineWithOptionCollect(t, r, s) {
                        setProperty(c, t, function(t, e, n) {
                            ...
                            return function defineMethods(r, t, s, a, o) {
                                g(t, function(t, e) {
                                    var n, i = t;
                                    a && (i = wrapMethodWithArguments(t)), o && (i.flags = o), s & d && !t.instance && (n = function wrapInstanceMethod(t, e) {
                                    ...
                                    }(t, a), setProperty(i, "instance", n)), s & f && setProperty(i, "static", !0), setMethod(r, e, i), r.active && r.extend(e)
                                })
                    ...
                    value: function sortOptions(t) {
                        ...
                        if (this.customSorter && -1 !== this.customSorter.col.indexOf(t)) {
                            ...
                            var o = n.getDecimal(t),
                                u = f.numSortAsc;
                            !0 !== s && -1 === s.indexOf(t) || (u = f.numSortDesc), i = Object(f.sortNumberStr)(u, o)
                        } else if (n.hasType(t, [h.DATE])) {
                            var l = n.feature("dateType").getLocale(t),
                                c = f.dateSortAsc;
                            i = Object(f.sortDateStr)(c, l)
                        } else i = r ? void 0 : f.ignoreCase;
                        return e.sort(i)
                    }
                }, {
                    key: "refreshFilters",
        ...
        var f = "https://wwwwwww.tablefilter.com/",
            d = function(t) {
                function Help(t) {
                    // var e;
                    // ! function _classCallCheck(t, e) {
                    ...
                    // return e.tgtId = Object(a.defaultsStr)(n.target_id, null), e.contTgtId = Object(a.defaultsStr)(n.container_target_id, null), e.instrText = Object(l.isEmpty)(n.text) ? '' : n.text, e.instrHtml = Object(a.defaultsStr)(n.html, null), e.btnText = Object(a.defaultsStr)(n.btn_text, "?"), e.btnHtml = Object(a.defaultsStr)(n.btn_html, null), e.btnCssClass = Object(a.defaultsStr)(n.btn_css_class, "helpBtn"), e.contCssClass = Object(a.defaultsStr)(n.container_css_class, "helpCont"), e.btn = null, e.cont = null, e.boundMouseup = null, e.defaultHtml = '<div class="helpFooter"><h4>TableFilter v' + t.version + '</h4><a href="' + f + '" target="_blank">' + f + "</a><br/><span>&copy;2015-" + t.year + ' Max Guglielmi</span><div align="center" style="margin-top:8px;"><a href="javascript:void(0);" class="close">CloseAll</a></div></div>', e.toolbarPosition = Object(a.defaultsStr)(n.toolbar_position, c.RIGHT), e.emitter.on(["init-help"], function() {
                    //     return e.init()
                    // }), e
                }
                return function _inherits(t, e) {
        ...
        var g = n(116),
            ...
            G = r.MONTH_INDEX,
            q = r.YEAR_INDEX;
        t.exports = function getExtendedDate(a, t, e, n) {
            var o, u, l, c, f, d, h, p, m, i, y, r;
            ...
            function parseFormatValues(r, t) {
                ...
                return O(t.to, function(t, e) {
                    ...
                    i && (n = function parseIrregular(t, e) {
                        ...
                        if ("year" === e) {
                            var n = t.match(b);
                            if (n) return M(n[1], o, h)
                        }
                    }(i, t), E(n) && (n = l.parseValue(i, t)), s[t] = n)
                }), s
            }

            function cloneDateByFlag(t, e) {
                return s(t) && !C(m) && (m = !0), s(t) && !C(i) && (i = !0), e && (t = new Date(t.getTime())), t
            }
            ...
            function handleTimezoneOffset(t, e) {
                s(o, !0), t < 0 && (e *= -1);
                var n = 60 * t + (e || 0);
                n && (u.minute = (u.minute || 0) - n)
            }

            function handleMidday(t) {
                u.hour = t % 24, 23 < t && afterDateSet(function() {
                    S(o, "date", v(t / 24))
                })
            }
            ...
            function handleRelativeUnit(t) {
                var e;
                e = C(u.num) ? u.num : C(u.edge) && E(u.shift) ? 0 : 1, C(u.weekday) && (t === G ? (setOrdinalWeekday(e), e = 1) : (k(o, {
                        weekday: u.weekday
                    }, !0), delete u.weekday)), u.half && (e *= u.half), C(u.shift) ? e *= u.shift : u.sign && (e *= u.sign), C(u.day) && (e += u.day, delete u.day),
                    function separateAbsoluteUnits(r) {
                        var s;
                        A(u, function(t, e, n, i) {
                            if (r <= i) return o.setTime(NaN), !1;
                            i < r && ((s = s || {})[t] = e, D(u, t))
                        }), s && (afterDateSet(function() {
                            k(o, s, !0, 0, !1, d), y && P(y, s)
                        }), u.edge && (handleEdge(u.edge, s), delete u.edge))
                    }(t), u[U.units[t]] = e, f = !0
            }
            ...
            function handleEdge(e, r) {
                ...
                s || L(r, function(t, e, n, i) {
                    ...
                    var t;
                    e < 0 ? R(o, s, p) : 0 < e && (1 === e && R(o, t = Y), I(o, s, p, t)), C(n) && (j(o, n, -e), w(o))
                }), r.specificity = s === G ? Y : s - 1
            }

            function setOrdinalWeekday(t) {
                u.weekday = 7 * (t - 1) + u.weekday, u.date = 1, d = 1
            }
            return c = [],
                function setupOptions(t) {
                    t = B(t) ? {
                        locale: t
                    } : t || {}, h = +!!W(t, "future") - +!!W(t, "past"), p = W(t, "locale"), m = W(t, "fromUTC"), i = W(t, "setUTC"), y = W(t, "params"), r = W(t, "clone")
                }(e), o = a && t ? cloneDateByFlag(a, !0) : x(), s(o, m), B(t) ? o = function parseStringDate(t) {
                    t = t.toLowerCase(), l = V.get(p);
                    for (var e, n, i = 0; e = l.compiledFormats[i]; i++)
                        if (n = t.match(e.reg)) {
                            if (l.cacheFormat(e, i), u = parseFormatValues(n, e), C(u.timestamp)) {
                                o.setTime(u.timestamp);
                                break
                            }
                            C(u.ampm) && (1 === (s = u.ampm) && u.hour < 12 ? u.hour += 12 : 0 === s && 12 === u.hour && (u.hour = 0)), (u.utc || C(u.tzHour)) && handleTimezoneOffset(u.tzHour, u.tzMinute), C(u.shift) && E(u.unit) && (C(u.month) ? u.unit = q : C(u.weekday) && (u.unit = K)), C(u.num) && E(u.unit) && (r = u.num, C(u.weekday) ? setOrdinalWeekday(r) : C(u.month) && (u.date = u.num)), u.midday && handleMidday(u.midday), C(u.day) && (u.day, w(o), E(u.unit) && (u.unit = Y, u.num = u.day, delete u.day)), C(u.unit) && handleRelativeUnit(u.unit), u.edge && handleEdge(u.edge, u);
                            break
                        } var r, s;
                    return u ? f ? k(o, u, !1, 1) : k(o, u, !0, 0, h, d, a) : (o = new Date(t), m && T(o) && o.setTime(o.getTime() + _(o) * g)),
                        function fireCallbacks() {
                            O(c, function(t) {
                                t.call()
                            })
                        }(), o
                }(t) : z(t) ? o = cloneDateByFlag(t, r || n) : N(t) ? (u = F(t), k(o, u, !0)) : (H(t) || null === t) && o.setTime(t), s(o, !!i), {
                    set: u,
                    date: o
                }
        }
        ...
        try {
            S6 = S6 || Function("return this")() || eval("this")
        } catch (t) {
            "object" == typeof window && (S6 = window)
        }
        Q6.exports = S6
    }, function(t, e, s) {
        "use strict";
        ...
        var S = n.root.document,
            ...
            i = function() {
                function TableFilter() {
                    ...
                    ! function _classCallCheck(t, e) {
                        if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
                    }(this, TableFilter), this.id = null, this.version = "0.6.86", this.year = (new Date).getFullYear(), this.tbl = null, this.refRow = null, this.headersRow = null, this.cfg = {}, this.nbFilterableRows = 0, this.nbCells = null, this.hasConfig = !1, this.initialized = !1;
        ...
        ! function buildDateFormatTokens() {
            ...
            function buildAlternate(n, i) {
                ...
                addFormats(r, n.ldml + i, t), n.lowerToken && (r[n.lowerToken + i] = buildLowercase(t))
            }
                ...
                init: function(t) {
                    ...
                    function getFormatWithTime(t, e) {
                        return e ? function getTimeBefore() {
                            ...
                            var t, e = ",?[\\s\\u3000]";
                            return (t = C(l.timeMarkers)) && (e += "| (?:" + t + ") "), e = v(e, l.timeMarkerOptional), v(e + "{time}{tzOffset}", !0)
                        }()
                    ...
                    function initArrayFields() {
                        ...
                        function buildTimeFormats() {
                            l.parsingAliases.time = function getTimeFormat(t) {
                                var e;
                                return e = function getTimeSeparatorSrc() {
                                    return l.timeSeparator ? "[:" + l.timeSeparator + "]" : ":"
                                }(), l.ampmFront ? "{ampm?} {hour} (?:{minute} (?::?{second})?)?" : l.ampm.length ? "{hour}(?:" + e + "{minute?}(?:" + e + "{second?})? {ampm?}| {ampm})" : "{hour}(?:" + e + "{minute?}(?:" + e + "{second?})?)"
                        ...
                        function buildParsingTokens() {
                            S(a, function(t, e) {
                                ...
                                (t.requiresNumerals || l.numeralUnits) && (i += function getNumeralSrc() {
                                    var t, e = "";
                                    return t = l.numerals.concat(l.placeholders).concat(l.articles), l.allowsFullWidth && (t = t.concat(T.split(""))), t.length && (e = "|(?:" + C(t) + ")+"), e
