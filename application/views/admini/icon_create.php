              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                   ...
                   <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo base_url(); ?>admini/icon/uploadIcon" method="post" enctype="multipart/form-data">
                        <div id="step-1">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div id="image-preview" style="border: 1px solid #ccc;background-repeat: no-repeat;
    background-size: 100%; ">
