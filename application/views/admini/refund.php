                  ...
                  <div class="x_content">
                    ...
                    <div class="table-responsive">
                      <table id="example" class="table table-striped jambo_table bulk_action">
                        ...
                        <tbody>
                          <?php
                                $transactions = get_rows("transaction",array("status"=>"request_refund"),"date DESC");
                                foreach ($transactions as $key => $transaction) {
                                  $member = get_row("member",array("id"=>$transaction['user_id']));
                                    ...
                                    echo '<td>';
                                    ?>
                                    <form action="<?php echo base_url("admini/payment/refund"); ?>" method="post">
                                      <input type="hidden" name="id" value="<?php echo $transaction['id']; ?>">
                                      <button type="submit" class="btn-info"> Refund </button>
