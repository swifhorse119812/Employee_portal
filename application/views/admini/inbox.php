          ...
          <div class="">
            ...
            <div class="row" style="padding: 15px;">
                 <div class="col-md-12" style="padding: 20px; border: 1px solid #ccc;">
                    <?php 
                        $messages = get_rows("message",array("receiver"=>"admin"),"date DESC");
                    ?>
                    <p style="font-weight: 500;">
                        Message Inbox(<?php echo count($messages); ?>)
                    </p>
                    <table class="table table-striped" id="transaction_table" class="display" style="width:100%">
                     ...
                     <?php
                        foreach ($messages as $key => $message) {
                            ...
                            if($sender == "admin"){
                              $sender = "Virsympay Support";
                            } else {
                              $user = get_row("member",array("id"=>$sender));
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("body").on("click","#transaction_table tbody td",function(){
            ...
            document.location.replace(base_url+"?id="+id);
        })
