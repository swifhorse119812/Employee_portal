    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 wow fadeInLeft" data-wow-delay=".3s" >
                <img src="<?php echo base_url('assets/client_assets/images/about/about-company.jpg'); ?>" alt="" class="img-responsive">
            </div>
            <div class="col-md-6">
                <div class="block">
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="team-member wow fadeInLeft" data-wow-duration="500ms" data-wow-delay=".3s">
                    <div class="team-img">
                        <img src="<?php echo base_url('assets/client_assets/images/team/team-1.jpg" class="team-pic'); ?>" alt="">
                    </div>
            ...
            <div class="col-md-3">
                <div class="team-member wow fadeInLeft" data-wow-duration="500ms" data-wow-delay=".5s">
                    <div class="team-img">
                        <img src="<?php echo base_url('assets/client_assets/images/team/team-2.jpg" class="team-pic'); ?>" alt="">
                    </div>
            ...
            <div class="col-md-3">
                <div class="team-member wow fadeInLeft" data-wow-duration="500ms" data-wow-delay=".7s">
                    <div class="team-img">
                        <img src="<?php echo base_url('assets/client_assets/images/team/team-3.jpg" class="team-pic'); ?>" alt="">
                    </div>
            ...
            <div class="col-md-3">
                <div class="team-member wow fadeInLeft" data-wow-duration="500ms" data-wow-delay=".9s">
                    <div class="team-img">
                        <img src="<?php echo base_url('assets/client_assets/images/team/team-4.jpg" class="team-pic'); ?>" alt="">
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div id="clients-logo" class="owl-carousel">
                            <div>
                                <img src="<?php echo base_url('assets/client_assets/images/clients/logo-1.jpg'); ?>" alt="">
                            </div>
                            <div>
                                <img src="<?php echo base_url('assets/client_assets/images/clients/logo-2.jpg'); ?>" alt="">
                            </div>
                            <div>
                                <img src="<?php echo base_url('assets/client_assets/images/clients/logo-3.jpg'); ?>" alt="">
                            </div>
                            <div>
                                <img src="<?php echo base_url('assets/client_assets/images/clients/logo-4.jpg'); ?>" alt="">
                            </div>
                            <div>
                                <img src="<?php echo base_url('assets/client_assets/images/clients/logo-5.jpg'); ?>" alt="">
                            </div>
                             <div>
                                <img src="<?php echo base_url('assets/client_assets/images/clients/logo-1.jpg'); ?>" alt="">
                            </div>
